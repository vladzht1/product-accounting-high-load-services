...
export const PG_DATABASE = process.env["PG_DATABASE"] || "product-accounting";
...
export const SERVER_HOST = process.env["REMAINS_SERVICE_HOST"] || "localhost";
export const SERVER_PORT = parseInt(process.env["REMAINS_SERVICE_PORT"] || "5050");
